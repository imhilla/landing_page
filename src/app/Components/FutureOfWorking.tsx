...
export default function FutureOfWorking() {
  return (
    <div className='min-h-screen bg-white px-10 md:p-20 flex flex-col md:flex-row w-full'>
      <div className='flex flex-col justify-center items-center md:w-1/2'>
        <h1 className='font-bold mb-4 self-start md:mb-6 text-2xl md:text-3xl p-3'>Future of working is here</h1>
        ...
        <div className='grid grid-cols-2 gap-5 md:gap-9 md:mt-4 md:self-start md:p-3'>

...
export default function ModernConviniences() {
  return (
    <div className='min-h-screen bg-white p-10 md:p-20 lg:p-20 2xl:p-40 flex flex-col justify-center items-center w-full'>
      <h1 className='font-semibold mb-4 md:w-2/3 text-center text-2xl md:text-4xl'>The modern conviniences of this co-working place</h1>
      <div className='w-full grid gap-5 grid-cols-1 md:flex mt-4'>
        <div className='w-full md:w-4/5 bg-slate-100 rounded p-10 flex flex-col justify-center items-center shadow-lg hover:bg-white transition duration-150 ease-in-out'>
          <span className='my-6'>
